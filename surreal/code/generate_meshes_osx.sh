...
do
    ...
    do
        ...
        do
                blender -b -t 1 -P export_human_meshes.py -- --idx $i --ishape 0 --stride 50 --gender $GENDER --body_shape_idx $R --outdir human_meshes
        done
...
blender -b -P verify_human_mesh_generation.py

# Collect the relevant textures needed for the meshes
blender -b -P collect_human_textures.py
